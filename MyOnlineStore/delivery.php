...
if (!isset($_SESSION["cart_array"]) || count($_SESSION["cart_array"]) < 1) {
    ...
    foreach ($_SESSION["cart_array"] as $each_item) { 
		...
		$cartOutput .= '<div class="shopp" id="each-'. $item_id .'"><div class="label" align="left">'. $product_name .'</div><div class="shopp-price" align="left"> Rs. <em>'. $price .'</em></div><div class="shopp-quantity"><form action="index.php" method="post">
		<input name="quantity" type="text" value="' . $each_item['quantity'] . '" size="1" maxlength="2" />
		<input name="adjustBtn' . $item_id . '" type="submit" value="change" />
		<input name="item_to_adjust" type="hidden" value="' . $item_id . '" />
		</form></div></em><div class="pricetotal" align="left">' . $pricetotal .      '</div><div class="remove">    <form action="index.php" method="post"><input type="image" name="deleteBtn' . $item_id . '" src="remove.png" /><input name="index_to_remove" type="hidden" value="' . $i . '" /></form></div></div>';
		$i++; 
    } 
	setlocale(LC_MONETARY, "en_US");
...
if (isset($_POST['Name'])) {
	...
	$_SESSION['order_sex']=$Sex;
	$_SESSION['order_add']=$Address;
	$_SESSION['order_pn']=$phn;
...
<div align="center" id="mainWrapper">
  ...
  <table border="0" cellpadding="0" cellspacing="0"  style="background: url(images/left_bg.gif)">
				<tr>
					...
					<td width="450"><div class="lb">Shopping Cart</div> <div class="lw">Shopping Cart</div></td>
       ...
       <div id="left_bar">
      <div class="cart-info">
     <div class="shopp" id="id"><div class="label" align="left"><b>Product Name</b></div><div class="shopp-price" align="left"> <em><b>price</b></em></div><div class="shopp-quantity"><b>Quantity</b></div><div class="pricetotal" align="left"><b>Price*QTY</b></div><div class="remove"><b>Remove</b></div></div>
     <?php echo $cartOutput; ?>
     <!-- <tr>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
    ...
    <div class="cart-total" align="left"><?php echo $cartTotal; ?></div>
    </tr>
					</table>
...
<?php //echo $pp_checkout_btn; ?>
    ...
    <div>
    <p>
      <form action="delivery.php" enctype="multipart/form-data" name="myForm" id="myform" method="post">
        ...
        <div class="label" align="left"><input name="pn" align="left" value="<?php echo $pn; ?>" type="text"></div>
                        ...
                        <br/>
                        <input type="image" src="style/submit_payment.gif" name="submit" alt="Cash on Delivery" />
        </div>
      <div style="display: none;"><input type="hidden" name="_sourcePage" value="qDiGoYz0EIrS2_Z7twth3fpZneCYx8Rn7AWIQ8nZftQ="><input type="hidden" name="__fp" value="yLT5uvRGkCo="></div></form>
